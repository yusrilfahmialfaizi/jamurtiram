...
class PerhitunganController extends Controller
{
    ...
    public function index(){
        ...
        // for ($i=1; $i <= $numEpoch ; $i++) { 
            // do {
        while ($i <= $numEpoch or $Error > 0.01) {
            // while ($i <= $numEpoch) {
        ...
        echo $bias."\n\n\n";
        echo "</pre>";
        // $this->testing($bX1Z1, $bX1Z2, $bX2Z1, $bX2Z2, $bias, $bZ1Y, $bZ2Y);
        // echo "<pre> bobot baru x1z1 : ";
        // echo $bX1Z1."\n\n bobot baru x1z2 : ";
        // echo $bX1Z2."\n\n bobot baru x2z1 : ";
        // echo $bX2Z1."\n\n bobot baru x2z2 : ";
    ...
    public function testing($bX1Z1, $bX1Z2, $bX2Z1, $bX2Z2, $bias, $bZ1Y, $bZ2Y){
    // public function testing(){
        // $dataset    = DB::table('data_testing')->get();

        // // get max
        // $datamaxTemp = DB::table('data_testing')->max('field1');
        // $datamaxHum = DB::table('data_testing')->max('field2');
        // echo "<pre>datamaxTemp = ".$datamaxTemp;
        // echo "\n";
        // echo "datamaxHum = ".$datamaxHum;
        // echo "\n\n\n</pre>";
        ...
        // ######################
        // // get min
        // $dataminTemp = DB::table('data_testing')->min('field1');
        // $dataminHum = DB::table('data_testing')->min('field2');
        // echo "<pre>dataminTemp = ".$dataminTemp;
        // echo "\n";
        // echo "dataminHum = ".$dataminHum;
        // echo "\n\n\n</pre>";
    ...
    //     // print_r($dataset);
        ...
        // for ($i=1; $i <= $numEpoch ; $i++) { 
            ...
            foreach ($datasetN as $data) {
                // DB::table('data_normalisasi_testing')->insert(array('entry_id' =>$data->entry_id, 'field1' => $data->field1, 'field2' =>$data->field2, 'field1_N'=>0, 'field2_N'=>0,));
                # code...
                // menjumlahkan bobot input layer ke hidden layer
                $Z_inZ1  = $bias + (($data->field1_N * $bX1Z1) + ($data->field2_N * $bX2Z1));
                $Z_inZ2  = $bias + (($data->field1_N * $bX1Z2) + ($data->field2_N * $bX2Z2));
